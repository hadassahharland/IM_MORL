...
public class LivingRoomWithTableConsiderateMVPOneRubbish implements EnvironmentInterface
{
...
//        }
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new LivingRoomWithTableConsiderateMVPOneRubbish());
        theLoader.run();
    }
