...
public class LivingRoomWithTableConsiderateMVPNoRubbish implements EnvironmentInterface
{
    ...
    private final int AGENT_GOAL = 14;   // location of agent at final goal
...
//        rubbishRemaining = COUNT_RUBBISH_SPAWN;   // at initialisation, rubbish in room equals total pieces of rubbish
    ...
    public int getState()
    {
        ...
        return agentLocation + (NUM_CELLS * tableLocation); //+ (NUM_CELLS * ???);
    }
...
//        }
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new LivingRoomWithTableConsiderateMVPNoRubbish());
        theLoader.run();
    }
