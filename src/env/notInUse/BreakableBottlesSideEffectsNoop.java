// Modified version of the BreakableBottles environment - adds an extra no-op action which doesn't change
...
public class BreakableBottlesSideEffectsNoop implements EnvironmentInterface
{  
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new BreakableBottlesSideEffectsNoop());
        theLoader.run();
    }
