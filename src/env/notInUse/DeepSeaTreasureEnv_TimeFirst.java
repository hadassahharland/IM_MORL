...
public class DeepSeaTreasureEnv_TimeFirst implements EnvironmentInterface
{  
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new DeepSeaTreasureEnv_TimeFirst());
        theLoader.run();
    }
