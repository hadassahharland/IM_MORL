...
public class LivingRoomWithTableConsiderateMVPRubbishUnderTable implements EnvironmentInterface
{
...
//        }
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new LivingRoomWithTableConsiderateMVPRubbishUnderTable());
        theLoader.run();
    }
