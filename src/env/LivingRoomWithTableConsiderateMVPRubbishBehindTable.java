...
public class LivingRoomWithTableConsiderateMVPRubbishBehindTable implements EnvironmentInterface
{
...
//    private final int RUBBISH_SPAWN[] = {0,0,1};   // locations of rubbish items
    private final int RUBBISH_SPAWN = 8;   // locations of rubbish items
...
//        }
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new LivingRoomWithTableConsiderateMVPRubbishBehindTable());
        theLoader.run();
    }
