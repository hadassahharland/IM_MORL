...
public class ApologeticSatisficingMILookupTable extends LookupTable implements ActionSelector
{
    ...
    public ApologeticSatisficingMILookupTable(int numberOfObjectives, int numberOfActions, int numberOfStates, int initValue)
    {
...
//    } // MI altered
    ...
    public int chooseGreedyAction(int state) 
    {
    	...
    	int greedy = TLO_MI.greedyAction(thisStateValues, Thresholds.getThresholds());
    	// JUST FOR DEBUGGING
    ...
    {  
    	getActionValues(state);
    	int best = TLO_MI.greedyAction(thisStateValues, Thresholds.getThresholds());
    	// this action is greedy if it is TLO-equal to the greedily selected action
    	return (TLO_MI.compare(thisStateValues[action], thisStateValues[best], Thresholds.getThresholds())==0);
    }
    ...
    protected int softmaxTournament(double temperature, int state)
    {
    	...
    	double scores[] = TLO_MI.getDominanceScore(thisStateValues,Thresholds.getThresholds());
    ...
    public double[] getThresholds() {
        return Thresholds.getThresholds();
    }

    public void setThresholds(double[] thresholds) {
        Thresholds.setThresholds(thresholds);
        this.thresholds = Thresholds.getThresholds();
    }
