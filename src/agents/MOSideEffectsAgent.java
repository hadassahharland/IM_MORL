...
import tools.valuefunction.SideEffectLookupTable; //WAS SideEffectLookupTable
...
public class MOSideEffectsAgent implements AgentInterface {

    SideEffectLookupTable vf = null; //WAS SideEffectLookupTable
    ...
    public void agent_init(String taskSpecification) {
    	System.out.println("MOSideEffectsAgent launched");
        ...
        vf = new SideEffectLookupTable(numOfObjectives, numActions, numStates, 0, impactThreshold);  //WAS SideEffectLookupTable
    ...
    public String agent_message(String message) {
        ...
        if (message.equals("freeze_learning")) {
            ...
            System.out.print("MOSideEffectsAgent: Weights can not be changed");
            return "MOSideEffectsAgent: Weights can not be changed";
        }
        ...
        System.out.println("MOSideEffectsEgent - unknown message: " + message);
        return "MOSideEffectsAgent does not understand your message.";
    }

    public static void main(String[] args) {
        AgentLoader theLoader = new AgentLoader( new MOSideEffectsAgent() );
        theLoader.run();
